...
public class MonsterRenderer extends GraphicalObject {
  private ArrayList<GraphicalObject> formes;

  public MonsterRenderer(float x, float y, float z, float aX, float aY, float aZ, float r, float g, float b,
      float scale) {
    super(x, y, z, aX, aY, aZ, r, g, b, scale);
    this.formes = new ArrayList<GraphicalObject>();
    this.formes.add(new Cube("assets/arrow.png", 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 1f, 1f));
  }
